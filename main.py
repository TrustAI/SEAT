# -*- coding: utf-8 -*-
# adopted from Daza et al. https://github.com/BCV-Uniandes/ROG
...
def main(rank, world_size, args):
    ...
    train_loader = DataLoader(
        ...
        num_workers=12, collate_fn=train_collate)
    val_loader = DataLoader(
        val_dataset, sampler=None, batch_size=info['test_batch'],
        num_workers=12, collate_fn=val_collate)
    ...
    if training:
        ...
        for epoch in range(epoch + 1, args.epochs + 1):
            ...
            train_loss, noise_data, _ = trainer.train(
    ...
    if args.adv:
        adversary = AutoAttack(
            ...
            log_path=os.path.join(args.save_path, f'log_autoattack_{args.eps}_{args.adv_iters}'),
        ...
        # attck = ['apgd-seg', 'apgd-cos', 'apgd-ang', 'apgd-ce', 'pgd']
        attck = ['apgd-cos']
        # attck = ['apgd-cos']
