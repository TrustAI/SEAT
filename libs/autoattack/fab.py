...
class FABAttack():
    ...
    def attack_single_run(self,b_min,b_max,b_eps, x, y=None, use_rand_start=False,):
        """
        ...
        while counter_restarts < 1:
            if use_rand_start:
                ...
                x1 = im2 + (torch.min(res2,
                                      self.eps * b_eps*torch.ones(res2.shape)
                                      .to(self.device)
            ...
            for target_class in range(2, self.n_target_classes + 2):
                ...
                for counter in range(self.n_restarts):
                    ...
                    if ind_to_fool.numel() != 0:
                        ...
                        adv_curr = self.attack_single_run(b_min,b_max,b_eps,
                        ...
                        acc_curr = torch.max(acc_curr, res > (self.eps*b_eps))
